...
<html>
<head>
<title>change_librarian_accounts</title>
<meta charset="utf-8">
...
<script>
	function on() {
		if ("<s:property value="changeMessage"/>" == "Username can not be blank!") {
			alert("Username can not be blank!");
		} else if ("<s:property value="changeMessage"/>" == "Username should be in 15 digits!") {
			alert("Username should be in 15 digits!");
		} else if ("<s:property value="changeMessage"/>" == "Username have been registered!") {
			alert("Username have been registered!");
		} else if ("<s:property value="changeMessage"/>" == "No librarian account with this id!") {
			alert("No librarian account with this id!");
		} else if ("<s:property value="changeMessage"/>" == "Change Success!") {
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					...
					<li class="layui-nav-item"><a href="javascript:;">Librarian
						...
						<dl class="layui-nav-child">
							...
							<dd>
								<a href="change_librarian_accounts.jsp" class="layui-this">Change</a>
							</dd>
							<dd>
		...
		<div class="layui-body">
			...
			<div style="padding: 15px;">
				...
				<fieldset class="layui-elem-field layui-field-title">
					<legend>Change Librarian Accounts</legend>
				</fieldset>
				...
				<div style="padding: 20px; background-color: #f2f2f2;">
					<div class="Content-Main">
						<div class="layui-container" style="margin-top: 10px;">
							...
							<form method="POST" action="changeLibrarian">
								<div class="layui-form-item">
									<label class="layui-form-label">Librarian Id</label>
									<div class="layui-input-inline">
										<tr>
											<input name="id" type="text" id="id"
												placeholder="enter your id" class="layui-input" />
										</tr>
									</div>
								</div>
								<div class="layui-form-item">
									<label class="layui-form-label">Username Change To</label>
									<div class="layui-input-inline">
										<tr>
											<input name="username" type="text" id="username"
												placeholder="enter new username" class="layui-input" />
										</tr>
									</div>
								</div>
								<div class="layui-form-item">
									<div class="layui-input-block">
										<button type="SUMBIT" value="Change" class="layui-btn"
											lay-submit lay-filter="formDemo">Change</button>
