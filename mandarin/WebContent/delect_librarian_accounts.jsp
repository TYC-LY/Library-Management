...
<html>
<head>
<title>delect_librarian_accounts</title>
<meta charset="utf-8">
...
<script>
	function on() {
		if ("<s:property value="delectMessage"/>" == "Username can not be blank!") {
			alert("Username can not be blank!");
		} else if ("<s:property value="delectMessage"/>" == "Username should be in 15 digits!") {
			alert("Username should be in 15 digits!");
		} else if ("<s:property value="delectMessage"/>" == "Username does not exist!") {
			alert("Username does not exist!");
		} else if ("<s:property value="delectMessage"/>" == "Delect Success!") {
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					...
					<li class="layui-nav-item"><a href="javascript:;">Librarian
						...
						<dl class="layui-nav-child">
							...
							<dd>
								<a href="delect_librarian_accounts.jsp" class="layui-this">Delect </a>
							</dd>
							<dd>
		...
		<div class="layui-body">
			...
			<div style="padding: 15px;">
				...
				<fieldset class="layui-elem-field layui-field-title">
					<legend>Delect Librarian Accounts</legend>
				</fieldset>
				...
				<div style="padding: 20px; background-color: #f2f2f2;">
					<div class="Content-Main">
						<div class="layui-container" style="margin-top: 10px;">
							...
							<form method="POST" action="delectLibrarian">
								...
								<div class="layui-form-item">
									<div class="layui-input-block">
										<button type="SUMBIT" value="Delect" class="layui-btn"
											lay-submit lay-filter="formDemo">Delect</button>
