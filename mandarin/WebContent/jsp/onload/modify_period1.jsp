...
<head>
  ...
  <meta http-equiv="refresh" content="0;url=onloadPeriod.action"/> 
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
    		...
    		<dl class="layui-nav-child">
      			<dd><a href="http://localhost:8080/mandarin/modify_finevalue1.jsp">FineValue</a></dd>
      			<dd><a href="javascript:;" class="layui-this">ReturnPeriod</a></dd>
      			<dd><a href="http://localhost:8080/mandarin/modify_deposit1.jsp">SecurityDeposit</a></dd>
    		</dl>
  		</li>
