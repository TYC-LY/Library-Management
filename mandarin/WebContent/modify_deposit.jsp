...
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item layui-nav-itemed"><a
						...
						<dl class="layui-nav-child">
							...
							<dd>
								<a href="modify_deposit-onload.jsp" class="layui-this">SecurityDeposit</a>
							</dd>
		...
		<div class="layui-body">
			...
			<div style="padding: 15px;">
				<div action="Admin.do" method="post" id="box"
					style="margin-top: 20px;">
					<h2>SecurityDeposit</h2>
					<hr class="layui-bg-green">
					<h3>
						The current reader pays a deposit of
						<s:property value="depo" />
						yuan when creating an account.
					</h3>
					<hr><br>
					<!-- 按钮：用于打开模态框 -->
					<button type="button" class="layui-btn layui-btn layui-btn-sm"
						data-toggle="modal" data-target="#Deposit">Modify Deposit</button>
	...
	<jsp:include page="Deposit.jsp" flush="true" />
