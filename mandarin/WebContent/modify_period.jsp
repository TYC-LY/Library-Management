...
<div class="layui-layout layui-layout-admin">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item layui-nav-itemed"><a
						...
						<dl class="layui-nav-child">
							...
							<dd>
								<a href="modify_period-onload.jsp" class="layui-this">ReturnPeriod</a>
							</dd>
							<dd>
  ...
  <div class="layui-body">
    ...
    <div style="padding: 15px;">
   	 	<div  action="Admin.do" method="post" id="box" style="margin-top: 20px;">  
    		<h2>ReturnPeriod</h2>
    		<hr class="layui-bg-green">
			<h3>The current book return period is 
			<s:property value="peri"/> days</h3>
			<hr><br>
			<!-- 按钮：用于打开模态框 -->
			<button type="button" class="layui-btn layui-btn layui-btn-sm"
					data-toggle="modal" data-target="#ReturnPeriod">Modify Period</button>	
		   </div> 
    </div>
  </div>
...
layui.use('element', function(){
 ...
 <!-- 模态框 Reader Management_RegisterReader -->
				<jsp:include page="ReturnPeriod.jsp" flush="true" />
